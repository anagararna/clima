                    ...
                    <div className="card mb-3 mx-auto bg-dark text-light">
                        <div className="row g-0">
                            <div className="col-md-4">
                                ...
                                <img src="https://images.pexels.com/photos/11511728/pexels-photo-11511728.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start" alt="..." />
                            </div>
                            <div className="col-md-8">
                                <div className="card-body text-start mt-2">
                                    <h5 className="card-test">Temperatura max: {(weather.main.temp_max - 273.15).toFixed(1)}ºC</h5>
                                    <h5 className="card-test">Temperatura min: {(weather.main.temp_min - 273.15).toFixed(1)}ºC</h5>
                                    <h5 className="card-test">Sensación térmica: {(weather.main.feels_like - 273.15).toFixed(1)}ºC</h5>
                                    <h5 className="card-test">Humedad: {(weather.main.humidity)}%</h5>
                                    <h5 className="card-test">Viento {(weather.wind.speed)} m/s</h5>
                                </div>
                                <hr/>
